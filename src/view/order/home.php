<!-- <nav class="nav">
    <div class="menu">
        ...
        <ul class="menu__items">
            <li class="menu__item"><a class="menu__item" href="#">Maker Faire</a></li>
            <li class="menu__item"><a class="menu__item" href="#">DIY-pakket</a></li>
            <li class="highlight menu__item"><a class="menu__item" href="#">Tutorial</a></li>
            <li class="menu__item"><a class="menu__item" href="#">NL/FR</a></li>
        </ul>
    </div>
</nav> -->
...
<header class="header">
    <div class="header__info">
        ...
        <div class="button__wrapper">
            <button class="button">Naar de tutorial</button>
        </div>
    </div>
</header>
<div class="info">
    ...
    <div class="info__right">
        ...
        <p class="info__subtext subtext">Blokkeer alvast 30 april, 1 & 2 mei 2021 in je agenda.
            Want dan gaat de tweede editie van de Makers Faire door in de Chinastraat, een industriële site in hartje
            Gent.</p>
        <div class="button__wrapper">
            <a href="" target="_blank"><button class="button">Website Maker Faire</button></a>
        </div>
    </div>
</div>
...
<footer class="footer">
    <div class="sponsors">
        ...
        <img class="sponsor__img" height="100" src="../../assets/img/sponsors/logo_velleman.png" alt="">
    </div>
    <div class="footer__bottom--text">
        <p class="footer__text">Maker Faire Gent is independently organized and operated under license from Maker Media,
            Inc.</p>
        <p class="footer__text"><span class="span">© 2020 MAKE IN BELGIUM</span></p>
    </div>
</footer>